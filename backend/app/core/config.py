...
class Settings(BaseSettings):
    ...
    llm_provider: str = "openai"  # "openai" for OpenAI-compatible, or custom provider name like "Perplexity"
    ...
    def validate_config(self):
        ...
        if not self.api_key:
            import logging
            logging.getLogger(__name__).warning("API_KEY is not set. LLM features will not work until an API key is provided.")
